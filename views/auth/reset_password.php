...
<body class="<?= isset($_COOKIE['theme']) && $_COOKIE['theme'] == 'light' ? 'light-mode' : '' ?>">
    ...
    <div class="auth-container">
        ...
        <div style="text-align: center; margin-bottom: 1.5rem;">
            <h2 style="color: var(--text-main); font-size: 1.25rem; font-weight: 600; margin-bottom: 0.5rem;">Reset Password</h2>
            <p style="color: var(--text-muted); font-size: 0.9rem;">Masukkan password baru Anda.</p>
        </div>
        ...
        <form action="<?= BASE_URL ?>/reset-password" method="POST">
            ...
            <div class="form-group">
                ...
                <div style="position: relative;">
                    <input type="password" id="password" name="password" class="form-control" required placeholder="Minimal 6 karakter" minlength="6" style="padding-right: 40px;">
            ...
            <div class="form-group" style="margin-bottom: 1.75rem;">
                ...
                <div style="position: relative;">
                    <input type="password" id="password_confirm" name="password_confirm" class="form-control" required placeholder="Ulangi password baru" style="padding-right: 40px;">
                    <i class="fa-solid fa-eye" style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer; color: var(--text-muted);" onclick="const input = this.previousElementSibling; if(input.type === 'password'){ input.type = 'text'; this.classList.remove('fa-eye'); this.classList.add('fa-eye-slash'); } else { input.type = 'password'; this.classList.remove('fa-eye-slash'); this.classList.add('fa-eye'); }"></i>
                </div>
            </div>
            
            <button type="submit" class="btn btn-primary" style="margin-top: 0.5rem;">Simpan Password Baru</button>
        </form>

        <div class="auth-links" style="margin-top: 1.5rem;">
            Batal? <a href="<?= BASE_URL ?>/login">Kembali ke Login</a>
        </div>
    </div>
