...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        body.light-mode .btn-google:hover { background: #f1f5f9; }
...
<body class="<?= isset($_COOKIE['theme']) && $_COOKIE['theme'] == 'light' ? 'light-mode' : '' ?>">
    ...
    <div class="auth-container">
        ...
        <?php if (isset($loginError)): ?>
            <div style="background: rgba(244, 63, 94, 0.1); border: 1px solid rgba(244, 63, 94, 0.2); color: #f43f5e; padding: 0.75rem; border-radius: 0.5rem; font-size: 0.9rem; margin-bottom: 1.5rem; text-align: center;">
        ...
        <form action="<?= BASE_URL ?>/login" method="POST">
            ...
            <div class="remember-row" style="justify-content: space-between;">
                ...
                <a href="<?= BASE_URL ?>/forgot-password" style="font-size: 0.9rem; color: #818cf8; text-decoration: none; font-weight: 600;">Lupa Password?</a>
            </div>
