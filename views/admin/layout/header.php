...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            <div class="menu-group-title">Admin Panel</div>
            <a href="<?= BASE_URL ?>/admin" class="menu-item <?= ($active == 'admin_dashboard') ? 'active' : '' ?>" data-title="Dashboard">
                <i class="fa-solid fa-gauge"></i> <span class="menu-text">Dashboard</span>
            </a>
            <a href="<?= BASE_URL ?>/admin/users" class="menu-item <?= ($active == 'admin_users') ? 'active' : '' ?>" data-title="Pengguna">
                <i class="fa-solid fa-users"></i> <span class="menu-text">Pengguna</span>
            </a>
            <a href="<?= BASE_URL ?>/admin/courses" class="menu-item <?= ($active == 'admin_courses') ? 'active' : '' ?>" data-title="Mata Kuliah">
                <i class="fa-solid fa-layer-group"></i> <span class="menu-text">Mata Kuliah</span>
            </a>
            <a href="<?= BASE_URL ?>/admin/materials" class="menu-item <?= ($active == 'admin_materials') ? 'active' : '' ?>" data-title="Materi">
                <i class="fa-solid fa-file-pdf"></i> <span class="menu-text">Materi</span>
            </a>
            <a href="<?= BASE_URL ?>/admin/announcements" class="menu-item <?= ($active == 'admin_announcements') ? 'active' : '' ?>" data-title="Pengumuman">
                <i class="fa-solid fa-bullhorn"></i> <span class="menu-text">Pengumuman</span>
            </a>

            <div class="menu-group-title">Sistem</div>
            <a href="<?= BASE_URL ?>/dashboard" class="menu-item" data-title="Kembali ke Web Student" style="background: rgba(16, 185, 129, 0.1); color: #10b981; font-weight: 600;">
                <i class="fa-solid fa-arrow-left"></i> <span class="menu-text">Web Student</span>
            </a>
